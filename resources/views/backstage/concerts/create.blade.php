            ...
            <div class="row">
                <div class="col col-lg-4">
                    <div class="p-xs-y-4">
                        ...
                        <p class="text-dark-soft text-sm m-xs-b-4">Tell us who's playing! <em>(Please be Slayer!)</em>
                        </p>
                        <p class="text-dark-soft text-sm">Include the headliner in the concert name, use the subtitle
                            section to list any opening bands, and add any important information to the description.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col col-lg-4">
                    <div class="p-xs-y-4">
                        ...
                        <p class="text-dark-soft text-sm">True metalheads really only care about the obscure openers, so
                            make sure they don't get there late!</p>
                    </div>
                </div>
                <div class="col col-lg-8">
                    <div class="card">
